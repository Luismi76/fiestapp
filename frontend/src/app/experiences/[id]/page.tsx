              ...
              <div className="space-y-2">
                {experience.cancellationPolicy === 'FLEXIBLE' && (
                  <div className="text-sm text-gray-600 space-y-1.5">
                    <div className="flex items-center gap-2"><div className="w-2 h-2 rounded-full bg-emerald-500" /><span>100% de reembolso hasta 24h antes</span></div>
                    <div className="flex items-center gap-2"><div className="w-2 h-2 rounded-full bg-amber-500" /><span>50% de reembolso entre 12 y 24h antes</span></div>
                    <div className="flex items-center gap-2"><div className="w-2 h-2 rounded-full bg-red-500" /><span>Sin reembolso con menos de 12h</span></div>
                    <p className="text-xs font-medium text-emerald-600 pt-1">Flexible</p>
                  </div>
                )}
