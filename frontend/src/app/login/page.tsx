      ...
      <div className="px-4 -mt-24 pb-8 relative z-10">
        <div className="bg-white rounded-3xl p-6 shadow-xl">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button className="flex items-center justify-center gap-2 py-3.5 bg-white hover:bg-gray-50 border-2 border-gray-200 rounded-xl font-medium text-sm transition-colors">
            ...
            <button className="flex items-center justify-center gap-2 py-3.5 bg-black hover:bg-gray-900 text-white rounded-xl font-medium text-sm transition-colors">
