    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="px-4 -mt-20 pb-8 relative z-10">
        <div className="bg-white rounded-3xl p-6 shadow-xl">
          ...
          {/* Social Login */}
          <button className="w-full flex items-center justify-center gap-2 py-3.5 bg-white hover:bg-gray-50 border-2 border-gray-200 rounded-xl font-medium text-sm transition-colors">
