      ...
      <div className="flex-1">
        ...
        <div className="px-4 lg:px-6 -mt-20 lg:mt-6 pb-8 relative z-10">
          <div className="bg-white rounded-3xl p-6 shadow-xl lg:shadow-lg lg:border lg:border-gray-100 max-w-lg lg:max-w-xl">
            {/* Error */}
            {error && (
              <div className="bg-[var(--color-error-bg)] text-[var(--color-error)] px-4 py-3 rounded-xl mb-4 text-sm flex items-center gap-2">
              ...
              <div className="space-y-3 p-4 bg-gray-50 rounded-xl">
                ...
                <div>
                  <input
                    ...
                    type="text"
                    className="w-full px-4 py-2.5 bg-white border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all text-sm"
