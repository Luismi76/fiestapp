...
import { favoritesApi, FavoriteExperience } from '@/lib/api';
...
export default function FavoritesPage() {
  ...
  // Obtener ciudades y festividades unicas para filtros
            ...
            {filteredExperiences.length === 0 ? (
              <div className="text-center py-20">
                ...
                <p className="text-gray-500 mb-6">
                  {experiences.length === 0
                    ? 'Guarda experiencias que te interesen para verlas más tarde'
