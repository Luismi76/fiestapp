  ...
  return (
    ...
    <div className="min-h-screen bg-white md:bg-gray-50 pb-24 md:pb-8">
      ...
      <header className="bg-white border-b border-gray-100 sticky top-0 z-10">
        <div className="px-4 md:px-6 lg:px-8 py-4 lg:py-6 max-w-6xl mx-auto">
          <h1 className="text-xl lg:text-2xl font-bold text-gray-900">Mis favoritos</h1>
        ...
        {/* Tabs */}
        <div className="flex border-b border-gray-100 max-w-6xl mx-auto">
          <button
            onClick={() => setActiveTab('experiences')}
            className={`flex-1 md:flex-none md:px-8 py-3 text-sm font-medium transition-colors relative ${
      ...
      {/* Content */}
      <div className="p-4 md:px-6 lg:px-8 max-w-6xl mx-auto">
        {loading ? (
          ...
          <>
            ...
            {filteredExperiences.length === 0 ? (
              ...
              <div>
                <p className="text-sm text-gray-500 mb-4">{filteredExperiences.length} experiencias guardadas</p>
                      ...
                      <div className="flex md:flex-col">
                        ...
                        <div className="flex-1 p-3 md:p-4 flex flex-col justify-between">
                          <div>
                            ...
                            <h3 className="font-semibold text-gray-900 line-clamp-2 text-sm md:text-base">{exp.title}</h3>
                          </div>
          ...
          <>
            {festivals.length === 0 ? (
              ...
              <div>
                <p className="text-sm text-gray-500 mb-4">{festivals.length} festivales guardados</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                  {festivals.map((festival) => (
                    ...
                    >
                      <div className="flex md:flex-col">
                        {/* Imagen */}
                        <div className="w-32 md:w-full h-28 md:h-36 flex-shrink-0 relative">
                        <img
                        ...
                        <div className="flex-1 p-3 md:p-4 flex flex-col justify-between">
                          <div>
                            <h3 className="font-semibold text-gray-900 line-clamp-1 md:text-lg">{festival.name}</h3>
